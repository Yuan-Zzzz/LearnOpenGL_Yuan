...
int main()
{
    ...
    // 构建并编译着色器程序
    // ------------------------------------
    Shader lightingShader("./src/11_lighting_maps/colors.vert", "./src/11_lighting_maps/colors.frag");
    Shader lightCubeShader("./src/11_lighting_maps/light_cube.vert", "./src/11_lighting_maps/light_cube.frag");
