...
int main()
{
    ...
    // 构建并编译着色器程序
    // ------------------------------------
    Shader lightingShader("./src/13_multiple_lights/colors.vert", "./src/13_multiple_lights/colors.frag");
    Shader lightCubeShader("./src/13_multiple_lights/light_cube.vert", "./src/13_multiple_lights/light_cube.frag");
