...
int main()
{
    ...
    // 构建并编译着色器程序
    // ------------------------------------
    Shader lightingShader("./src/12_light_casters/colors.vert", "./src/12_light_casters/colors.frag");
    Shader lightCubeShader("./src/12_light_casters/light_cube.vert", "./src/12_light_casters/light_cube.frag");
