...
int main()
{
    ...
    // 构建并编译着色器程序
    // ------------------------------------
    Shader lightingShader("./src/11_lighting_maps_exercise01/colors.vert", "./src/11_lighting_maps_exercise01/colors.frag");
    Shader lightCubeShader("./src/11_lighting_maps_exercise01/light_cube.vert", "./src/11_lighting_maps_exercise01/light_cube.frag");
